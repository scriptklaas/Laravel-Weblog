...
<form action="{{ route('posts.update', $post->id) }}" id="createform" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PATCH')
    ...
    <textarea id="body" name="body" value="{{ $post->body }}">{{ $post->body }}</textarea>
    <br>
